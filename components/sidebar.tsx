    ...
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-56 flex-col border-r border-border bg-sidebar">
      ...
      <div className="flex h-16 items-center gap-2 border-b border-border px-4">
        ...
        <div className="flex flex-col">
          <span className="text-sm font-bold tracking-wider text-foreground">SPENDWISE</span>
          <span className="text-[10px] font-medium tracking-widest text-primary">AI</span>
        </div>
      </div>
